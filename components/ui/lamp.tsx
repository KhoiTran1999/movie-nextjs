...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative z-0 flex h-full w-full flex-col items-center justify-center overflow-hidden rounded-md bg-slate-950",
        className,
      )}
    >
      ...
      <div className="relative z-50 flex -translate-y-[230px] flex-col items-center px-5">
        {children}
      </div>
    </div>
  );
