...
import {Chart as Chartjs, Pie} from "chart.js"
...
interface DashboardType {
  ...
  featuresData: FeatureDataType
}

const Dashboard = async (props: DashboardType) => {
  const {featuresData, statisticsData} = props

  const data = {
    labels: ["Cinema", "Standalone", "TVSeries"],
    datasets: {
      labels: "Hello",
      data: [featuresData.cinema, featuresData.standalone, featuresData.tvSeries]
    }
  }
